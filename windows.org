...
#+begin_src bat :tangle c:/cmd/bin/setpath.bat :mkdirp yes
  @echo off
  reg add HKEY_CURRENT_USER\Environment /v PATH /d "%PATH%;C:\cmd;C:\cmd\ahk;C:\cmd\bin;C:\cmd\hours;C:\cmd\hours\bin;C:\cmd\shortcuts;C:\Users\%USERNAME%\Documents\Personal Admin\Vim\vim81;C:\Program Files\VideoLAN"
  call C:\cmd\bin\refresh.bat
#+end_src

/TODO: Paths in this list need reviewing./
...
#+begin_src ahk :tangle c:/cmd/ahk/spooler.ahk :mkdirp yes
  ...
  IfMsgBox Yes 
          Run, "C:\cmd\bin\spooler.vbs"
  Return
#+end_src

As you can see, it ends by calling a file =spooler.vbs=. This is /that/ file: 

#+begin_src vbscript :tangle c:/cmd/bin/spooler.vbs :mkdirp yes
...
TODO: My Emacs configuration doesn't currently know how to handle VBScript, and the snippet I've used to try and implement syntax highlighting isn't working:
