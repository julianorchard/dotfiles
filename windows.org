...
#+begin_src ahk :tangle c:/cmd/ahk/spooler.ahk :mkdirp yes
  ...
  IfMsgBox Yes 
          ...
          ; Run, "C:\cmd\bin\spooler.bat"
          ; Run, "powershell.exe -ExecutionPolicy bypass" -noexit -command "-NoLogo C:\cmd\bin\spooler.ps1"
          ; Run, "C:\cmd\bin\spooler.ps1 -ExecutionPolicy bypass -NoLogo "
...
Otherwise I previously used this /VBScript/:
